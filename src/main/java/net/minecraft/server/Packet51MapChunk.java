...
/** Cow Pull [ Spigot ] [ Use a lower compression level for chunk packets ] **/
public class Packet51MapChunk extends Packet {
    ...
    public Packet51MapChunk(Chunk chunk, boolean flag, int i) {
        ...
        Deflater deflater = new Deflater(4); // Cow Modify [ Spigot ] [ Use a lower compression level for chunk packets ]
    ...
    public void a(DataInput datainput) throws IOException { // Cow Modify - throws IOException
    ...
    public void a(DataOutput dataoutput) throws IOException { // Cow Modify - throws IOException
