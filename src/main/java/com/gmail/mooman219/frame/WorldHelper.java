...
public class WorldHelper {
    ...
    public static void playEffect(Location location, Effect effect, int id, int data, Vector offset, float speed, int particleCount) {
        location.getWorld().spigot().playEffect(location, effect, id, data, (float) offset.getX(), (float) offset.getY(), (float) offset.getZ(), speed, particleCount, 48);
    }

    public static void playEffect(Location location, Effect effect, Vector offset, float speed, int particleCount) {
        location.getWorld().spigot().playEffect(location, effect, 0, 0, (float) offset.getX(), (float) offset.getY(), (float) offset.getZ(), speed, particleCount, 48);
    }

    public static void playEffect(Location location, Effect effect, float speed, int particleCount) {
        location.getWorld().spigot().playEffect(location, effect, 0, 0, 0f, 0f, 0f, speed, particleCount, 48);
    }
