...
public class DatabaseManager {
    ...
    public CDPlayer downloadPlayerData(String username, DownloadType downloadType) {
        ...
        if(playerObject != null) {
            ...
            ret = new CDPlayer((ObjectId) playerObject.get("_id"), username);
            ...
            case LOGIN:
                ...
                ret = new CDPlayer((ObjectId) c_Users.findOne(usernameQuery).get("_id"), username);
    ...
    public void uploadPlayerData(CDPlayer playerData, UploadType uploadType) {
